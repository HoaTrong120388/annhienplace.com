...
Written by: 	MM-United bmms - (https://bootstrapmegamenu.com)
bmm Version:	7.0.0
...
if (/iPad|iPhone|iPod/.test(navigator.platform)) {
	...
	$(document).ready(function($) {
		$('.dropdown-img').attr('onclick', 'return true');
	});
}
...
;(function (factory) {
	...
	$.fn.waitForImages = function () {
		...
		// Spec: https://w3.org/TR/CSS2/syndata.html#value-def-uri
...
*/
(function($) {
	$('.close-switcher-bar').on('click', function(){
