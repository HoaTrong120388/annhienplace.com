                    ...
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="{{ route('frontend.home') }}">
                                <img alt="{{ $setting_result['main_seo_title'] }}" width="150" height="150" data-sticky-width="50" data-sticky-height="50" data-sticky-top="100" src="{{ FCommon::cover_thumbnail($setting_result['company_logo']) }}">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-row">
                        <nav class="header-nav-top">
                            <ul class="nav nav-pills">
                                @include('frontend.common.social-icon-page', ['class' => 1])
                        ...
                        <div class="header-nav-extended header-nav-extended-no-border header-nav-extended-lg-show-border order-1 order-lg-2">
                            <div class="header-nav-extend header-nav-extended-popup d-inline-flex">
                                ...
                                <div class="header-nav-extended-dropdown" id="headerDropdownSearch">
                                    <form role="search" action="{{ route("frontend.product.search") }}" method="get">
