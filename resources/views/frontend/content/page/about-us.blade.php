...
<section class="main-header main-header-blog" style="background-image:url(public/frontend/assets/images/gallery-1.jpg)">
    <header>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-sm-3">
                    <article>
                        ...
                        <div class="image">
                            <img src="public/frontend/assets/images/user-5.jpg" alt="" />
                        </div>
                ...
                <div class="col-sm-3">
                    <article>
                        ...
                        <div class="image">
                            <img src="public/frontend/assets/images/user-4.jpg" alt="" />
                        </div>
                        <div class="details details-social">
                            <div class="inner">
                ...
                <div class="col-sm-3">
                    <article>
                        ...
                        <div class="image">
                            <img src="public/frontend/assets/images/user-3.jpg" alt="" />
                        </div>
                        <div class="details details-social">
                            <div class="inner">
                                <a href="#"><i class="fa fa-facebook"></i></a>
...
<section class="banner" style="background-image:url(public/frontend/assets/images/gallery-7.jpg)">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
...
<section class="cards">
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                <figure>
                    <figcaption style="background-image:url(public/frontend/assets/images/blog-7.jpg)">
                        <img src="public/frontend/assets/images/blog-1.jpg" alt="" />
                    </figcaption>
            ...
            <div class="col-md-4">
                <figure>
                    <figcaption style="background-image:url(public/frontend/assets/images/blog-2.jpg)">
                        <img src="public/frontend/assets/images/blog-2.jpg" alt="" />
                    </figcaption>
            ...
            <div class="col-md-4">
                <figure>
                    <figcaption style="background-image:url(public/frontend/assets/images/blog-3.jpg)">
                        <img src="public/frontend/assets/images/blog-3.jpg" alt="" />
                    </figcaption>
            ...
            <div class="col-md-4">
                <figure>
                    <figcaption style="background-image:url(public/frontend/assets/images/blog-4.jpg)">
                        <img src="public/frontend/assets/images/blog-4.jpg" alt="" />
                    </figcaption>
            ...
            <div class="col-md-4">
                <figure>
                    <figcaption style="background-image:url(public/frontend/assets/images/blog-5.jpg)">
                        <img src="public/frontend/assets/images/blog-5.jpg" alt="" />
                    </figcaption>
...
<section class="history">
    <div class="container">
        ...
        <div class="row row-block">
            <div class="col-md-5 history-image" style="background-image:url(public/frontend/assets/images/blog-3.jpg)">
        ...
        <!-- === row item === -->
        <div class="row row-block">
            <div class="col-md-5 history-image" style="background-image:url(public/frontend/assets/images/blog-4.jpg)">
                <div class="history-title">
        ...
        <!-- === row item === -->
        <div class="row row-block">
            <div class="col-md-5 history-image" style="background-image:url(public/frontend/assets/images/blog-5.jpg)">
                <div class="history-title">
        ...
        <!-- === row item === -->
        <div class="row row-block">
            <div class="col-md-5 history-image" style="background-image:url(public/frontend/assets/images/blog-6.jpg)">
                <div class="history-title">
...
<section class="banner" style="background-image:url(public/frontend/assets/images/gallery-2.jpg)">
    <div class="container">
        <div class="row justify-content-center"">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <article>
                    <a href="article.html">
                        <div class="image">
                            <img src="public/frontend/assets/images/project-1.jpg" alt="" />
                        </div>
            ...
            <div class="col-sm-4">
                <article>
                    <a href="article.html">
                        <div class="image">
                            <img src="public/frontend/assets/images/project-2.jpg" alt="" />
                        </div>
                        <div class="entry entry-block">
            ...
            <div class="col-sm-4">
                <article>
                    <a href="article.html">
                        <div class="image">
                            <img src="public/frontend/assets/images/project-3.jpg" alt="" />
                        </div>
                        <div class="entry entry-block">
                            <div class="date">28 Mart 2017</div>
                            <div class="title">
...
<section class="quotes quotes-slider" style="background-image:url(public/frontend/assets/images/gallery-2.jpg)">
    <div class="container">
        <div class="row">
            ...
            <div class="quote-carousel">
                ...
                <div class="quote">
                    <div class="image">
                        <img src="public/frontend/assets/images/user-1.jpg" alt="" />
                    </div>
                    <div class="text">
                        <h4>Glen Jordan</h4>
                        <p>Ipsum dolore eros dolore <br />dolor dolores sit iriure</p>
