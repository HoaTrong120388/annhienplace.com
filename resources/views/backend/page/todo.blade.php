...
@section('content')
<form action="{{ URL::route('admin.page.todo') }}" method="post" enctype="multipart/form-data"data-single="true" action="/file-upload" >
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-2">
                        <select data-placeholder="Select categories" class="tail-select w-full" name="parent">
                            <option value="1" @if (isset($arrResult->parent) && $arrResult->parent == 1) selected @endif>Trang tĩnh</option>
                            <option value="2" @if (isset($arrResult->parent) && $arrResult->parent == 2) selected @endif>Giới thiệu</option>
                        </select>
                    </div>
                </div>
                {{-- <div class="mt-3">
