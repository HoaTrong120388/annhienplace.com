...
<form action="{{ URL::route("admin.$strControler.todo") }}" method="post" enctype="multipart/form-data"data-single="true" action="/file-upload" >
    ...
    <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            <input type="text" class="intro-y input input--lg w-full box pr-10 placeholder-theme-13" name="title" id="title" placeholder="Tiêu đề" value="{{ $arrResult->title ?? '' }}">
                ...
                <div class="post__content tab-content">
                    <div class="tab-content__pane p-5 active" id="content">
                        ...
                        <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5 mt-5">
                            ...
                            <div class="mt-5">
                                <textarea class="element-ckeditor" id="ckeditor_content" name="content" >{{ $arrResult->content ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5 mt-5">
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="intro-y box p-5">
                <div class="mt-3">
                    <label>Slug</label>
                    <input class="input w-full border mt-2" name="slug" value="{{ $arrResult->slug ?? '' }}">
                </div>
                <div class="mt-3">
                    <label>Public Date</label>
                    <input class="datepicker input w-full border mt-2" data-single-mode="true" name="public_date" value="{{ $arrResult->public_date ?? '' }}">
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    <label>Special</label>
                    <div class="mt-2">
                        <input class="input input--switch border" type="checkbox" name="special" @if (isset($arrResult->special) && $arrResult->special == 1) checked @endif>
                    </div>
                </div>
                <div class="mt-3">
                    <label>Layout</label>
