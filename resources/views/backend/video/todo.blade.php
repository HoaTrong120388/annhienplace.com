                ...
                <div class="post__content tab-content">
                    <div class="tab-content__pane p-5 active" id="content">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" class="input w-full border mt-2" name="summary" value="{{ $arrResult->summary ?? '' }}">
                        </div>
                        <div class="mt-2">
                            <label>Youtube ID</label>
                            <input type="text" class="input w-full border mt-2" name="content" value="{{ $arrResult->content ?? '' }}">
                        </div>
                    </div>
                </div>
