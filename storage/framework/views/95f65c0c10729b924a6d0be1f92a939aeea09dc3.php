                        ...
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img class="tooltip rounded-full" src="<?php if(isset($item->thumbnail)): ?> <?php echo e(FCommon::cover_thumbnail($item->thumbnail)); ?><?php endif; ?>">
                                </div>
                            </div>
                        </td>
                        <td><?php echo e(Str::limit($item->title, 100, '...')); ?></td>
                        <td><?php if($item->status == 1): ?><span class="text-theme-1">Hiện</span><?php else: ?><span class="text-theme-6">Ẩn</span><?php endif; ?></td>
