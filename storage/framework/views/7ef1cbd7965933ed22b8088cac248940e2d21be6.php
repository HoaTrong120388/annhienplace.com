...
<script src="<?php echo e(asset('public/all/plugin/mega-menu/jquery/jquery.common.min.js')); ?>"></script>
<script src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.js"></script>

<script src="<?php echo e(asset('public/all/plugin/bootstrap//js/bootstrap.min.js')); ?>"></script>
        
<!-- WLC Javascript Files -->
<script src="<?php echo e(asset('public/all/plugin/mega-menu/js/menu.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/all/plugin/mega-menu/js/menu.init.min.js')); ?>"></script>
