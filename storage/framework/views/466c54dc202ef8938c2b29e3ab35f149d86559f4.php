                    ...
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="<?php echo e(route('frontend.home')); ?>">
                                <img alt="<?php echo e($setting_result['main_seo_title']); ?>" width="165" height="165" data-sticky-width="50" data-sticky-height="50" data-sticky-top="118" src="<?php echo e(asset('public/frontend/assets/images/logo.jpg')); ?>">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-row pt-3">
                        <nav class="header-nav-top">
                            <ul class="nav nav-pills">
                                <?php echo $__env->make('frontend.common.social-icon-share', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
