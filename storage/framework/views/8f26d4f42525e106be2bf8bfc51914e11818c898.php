...
<div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
    ...
    <div class="text-white mt-10 lg:mt-0">
        ...
        <a href="<?php echo e(route("frontend.home")); ?>" class="intro-x inline-block button border border-white dark:border-dark-5 dark:text-gray-300 mt-10">Quay về trang chủ</a>
    </div>
</div>
<!-- END: Error Page -->
