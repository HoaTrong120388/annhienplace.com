                ...
                <div class="post__content tab-content">
                    <div class="tab-content__pane p-5 active" id="content">
                        ...
                        <div class="border border-gray-200 dark:border-dark-5 rounded-md p-5 mt-5">
                            ...
                            <?php if(isset($arrResult->album) && is_array($arrResult->album) && count($arrResult->album) > 0): ?>
                            <div class="mt-5">
                                <div class="intro-y grid grid-cols-12 gap-3 sm:gap-6 mt-5">
                                    <?php $__currentLoopData = $arrResult->album; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                                            <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                                                <div class="absolute left-0 top-0 mt-3 ml-3">
                                                    <input class="input border border-gray-500" name="album[]" value="<?php echo e($album); ?>" type="checkbox" checked>
                                                </div>
                                                <a href="javascript:void(0);" class="w-3/5 file__icon file__icon--image mx-auto">
                                                    <div class="file__icon--image__preview image-fit">
                                                        <img src="<?php echo e(FCommon::cover_thumbnail($album)); ?>">
                                                    </div>
                                                </a>
                                                <a href="javascript:void(0);" class="block font-medium mt-4 text-center truncate"><?php echo e($album); ?></a> 
                        ...
                        <div class="grid grid-cols-12 gap-5">
                            <div class="col-span-12">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="border-2 border-gray-200 border-dashed dz-clickable mt-2">
                                        <input type="file" name="file_banner_form_register" class="dropify" id="banner_form_register" data-default-file="<?php if(isset($arrResult->more_info->banner_form_register)): ?><?php echo e(FCommon::cover_thumbnail($arrResult->more_info->banner_form_register)); ?><?php endif; ?>"  />
                                        <input type="hidden" id="source_banner_form_register" name="banner_form_register" value="<?php echo e($arrResult->more_info->banner_form_register ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-content__pane p-5" id="shop">
                        <div class="p-5">
                            <div>
                                <label>Giá Bán</label>
                                <input type="text" class="input w-full border mt-2" name="price_out" value="<?php echo e($arrResult->price_out ?? ''); ?>">
                            </div>
                            <div class="mt-3">
                                <label>Giá Gốc</label>
                                <input type="text" class="input w-full border mt-2" name="price_old" value="<?php echo e($arrResult->price_old ?? ''); ?>">
                            </div>
                            <div class="mt-3">
                                <label>Hãng Sản Xuất</label>
                                <input type="text" class="input w-full border mt-2" name="brand" value="<?php echo e($arrResult->more_info->brand ?? ''); ?>">
                            </div>
                            <div class="mt-3">
                                <label>Xuất Xứ</label>
                                <input type="text" class="input w-full border mt-2" name="source" value="<?php echo e($arrResult->more_info->source ?? ''); ?>">
                            </div>
                            <div class="mt-3">
                                <label>Tình trạng (Còn hàng)</label>
                                <div class="mt-2">
                                    <input class="input input--switch border" type="checkbox" name="in_stocks" <?php if(isset($arrResult->in_stocks) && $arrResult->in_stocks == 1): ?> checked <?php endif; ?>>
                                </div>
                            </div>
                        </div>
                    </div>
