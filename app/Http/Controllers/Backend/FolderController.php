...
class FolderController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->controller_name = 'folder';
        $this->group = 4;
        $this->lst_catalog = Catalog::where('group', 4)->where('parent', 0)->get();
    }
    ...
    public function index(Request $request)
    {
        ...
        $data = array(
            'page_title'        => 'Post',
            'titlePage'         => 'Quản lý Catalog',

            'nav_main'          => 'folder',
            'nav_sub'           => 'folder-index',
